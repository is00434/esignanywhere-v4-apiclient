 ...
 */
@ApiModel(description = "This object is used for updating an existing user.   Properties, which are not set will not change the existing value.")
@JsonPropertyOrder({
  UserUpdateDescription.JSON_PROPERTY_EMAIL,
  UserUpdateDescription.JSON_PROPERTY_FIRST_NAME,
  UserUpdateDescription.JSON_PROPERTY_LAST_NAME,
  UserUpdateDescription.JSON_PROPERTY_USER_NAME,
  UserUpdateDescription.JSON_PROPERTY_SID,
  UserUpdateDescription.JSON_PROPERTY_JOB_TITLE,
  UserUpdateDescription.JSON_PROPERTY_PHONE_NUMBER,
  UserUpdateDescription.JSON_PROPERTY_ROLE,
  UserUpdateDescription.JSON_PROPERTY_IS_USER_MANAGER,
  UserUpdateDescription.JSON_PROPERTY_IS_ENABLED,
  UserUpdateDescription.JSON_PROPERTY_DEFAULT_SUBJECT,
  UserUpdateDescription.JSON_PROPERTY_DEFAULT_MESSAGE,
  UserUpdateDescription.JSON_PROPERTY_NOTIFY_RECIPIENT_ON_ACTION_NEEDED,
  UserUpdateDescription.JSON_PROPERTY_NOTIFY_SENDER_COMPLETE_ENVELOPE,
  UserUpdateDescription.JSON_PROPERTY_NOTIFY_SENDER_DECLINED,
  UserUpdateDescription.JSON_PROPERTY_NOTIFY_SENDER_DELIVERY_FAILED,
  UserUpdateDescription.JSON_PROPERTY_NOTIFY_SENDER_VIEWED,
  UserUpdateDescription.JSON_PROPERTY_AUTOMATED_DELEGATION_SETTINGS,
  UserUpdateDescription.JSON_PROPERTY_SIGNATURE_IMAGE,
...
public class UserUpdateDescription {
  ...
  public static final String JSON_PROPERTY_AUTOMATED_DELEGATION_SETTINGS = "AutomatedDelegationSettings";
  private AutomatedDelegationSettings automatedDelegationSettings;
  ...
  public UserUpdateDescription email(String email) {
  ...
  **/
  ...
  public UserUpdateDescription firstName(String firstName) {
  ...
  **/
  ...
  public UserUpdateDescription lastName(String lastName) {
  ...
  **/
  ...
  public UserUpdateDescription userName(String userName) {
  ...
  **/
  ...
  public UserUpdateDescription sid(String sid) {
  ...
  **/
  ...
  public UserUpdateDescription jobTitle(String jobTitle) {
  ...
  **/
  ...
  public UserUpdateDescription phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public UserUpdateDescription role(RoleEnum role) {
  ...
  **/
  ...
  public UserUpdateDescription isUserManager(Boolean isUserManager) {
  ...
  **/
  ...
  public UserUpdateDescription isEnabled(Boolean isEnabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Defines if the user is enabled.")
  ...
  public UserUpdateDescription defaultSubject(String defaultSubject) {
   ...
   /**
   * Defines the default subject used for sending envelopes
   * @return defaultSubject
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Defines the default subject used for sending envelopes")
  ...
  public UserUpdateDescription defaultMessage(String defaultMessage) {
   ...
   /**
   * Defines the default message used for sending envelopes
   * @return defaultMessage
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Defines the default message used for sending envelopes")
  ...
  public UserUpdateDescription notifyRecipientOnActionNeeded(Boolean notifyRecipientOnActionNeeded) {
  ...
  **/
  ...
  public UserUpdateDescription notifySenderCompleteEnvelope(Boolean notifySenderCompleteEnvelope) {
  ...
  **/
  ...
  public UserUpdateDescription notifySenderDeclined(Boolean notifySenderDeclined) {
  ...
  **/
  ...
  public UserUpdateDescription notifySenderDeliveryFailed(Boolean notifySenderDeliveryFailed) {
  ...
  **/
  ...
  public UserUpdateDescription notifySenderViewed(Boolean notifySenderViewed) {
  ...
  **/
  ...
  public UserUpdateDescription automatedDelegationSettings(AutomatedDelegationSettings automatedDelegationSettings) {
    
    this.automatedDelegationSettings = automatedDelegationSettings;
    return this;
  }

   /**
   * Get automatedDelegationSettings
   * @return automatedDelegationSettings
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_AUTOMATED_DELEGATION_SETTINGS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public AutomatedDelegationSettings getAutomatedDelegationSettings() {
    return automatedDelegationSettings;
  }


  public void setAutomatedDelegationSettings(AutomatedDelegationSettings automatedDelegationSettings) {
    this.automatedDelegationSettings = automatedDelegationSettings;
  }


  public UserUpdateDescription signatureImage(byte[] signatureImage) {
  ...
  **/
  ...
  public UserUpdateDescription authentications(List<UserAuthentication> authentications) {
    
    this.authentications = authentications;
    return this;
  }

  public UserUpdateDescription addAuthenticationsItem(UserAuthentication authenticationsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserUpdateDescription userUpdateDescription = (UserUpdateDescription) o;
    return Objects.equals(this.email, userUpdateDescription.email) &&
        Objects.equals(this.firstName, userUpdateDescription.firstName) &&
        Objects.equals(this.lastName, userUpdateDescription.lastName) &&
        Objects.equals(this.userName, userUpdateDescription.userName) &&
        Objects.equals(this.sid, userUpdateDescription.sid) &&
        Objects.equals(this.jobTitle, userUpdateDescription.jobTitle) &&
        Objects.equals(this.phoneNumber, userUpdateDescription.phoneNumber) &&
        Objects.equals(this.role, userUpdateDescription.role) &&
        Objects.equals(this.isUserManager, userUpdateDescription.isUserManager) &&
        Objects.equals(this.isEnabled, userUpdateDescription.isEnabled) &&
        Objects.equals(this.defaultSubject, userUpdateDescription.defaultSubject) &&
        Objects.equals(this.defaultMessage, userUpdateDescription.defaultMessage) &&
        Objects.equals(this.notifyRecipientOnActionNeeded, userUpdateDescription.notifyRecipientOnActionNeeded) &&
        Objects.equals(this.notifySenderCompleteEnvelope, userUpdateDescription.notifySenderCompleteEnvelope) &&
        Objects.equals(this.notifySenderDeclined, userUpdateDescription.notifySenderDeclined) &&
        Objects.equals(this.notifySenderDeliveryFailed, userUpdateDescription.notifySenderDeliveryFailed) &&
        Objects.equals(this.notifySenderViewed, userUpdateDescription.notifySenderViewed) &&
        Objects.equals(this.automatedDelegationSettings, userUpdateDescription.automatedDelegationSettings) &&
        Arrays.equals(this.signatureImage, userUpdateDescription.signatureImage) &&
        Objects.equals(this.authentications, userUpdateDescription.authentications);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, userName, sid, jobTitle, phoneNumber, role, isUserManager, isEnabled, defaultSubject, defaultMessage, notifyRecipientOnActionNeeded, notifySenderCompleteEnvelope, notifySenderDeclined, notifySenderDeliveryFailed, notifySenderViewed, automatedDelegationSettings, Arrays.hashCode(signatureImage), authentications);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserUpdateDescription {\n");
    ...
    sb.append("    automatedDelegationSettings: ").append(toIndentedString(automatedDelegationSettings)).append("\n");
