 ...
 */
@ApiModel(description = "TransactionCode SigType.")
@JsonPropertyOrder({
  SigTypeTransactionCode.JSON_PROPERTY_TR_MOD_TYPE,
  SigTypeTransactionCode.JSON_PROPERTY_TR_MOD_TYPE_ID,
  SigTypeTransactionCode.JSON_PROPERTY_TR_VALIDITY_IN_SECONDS,
  SigTypeTransactionCode.JSON_PROPERTY_LY,
  SigTypeTransactionCode.JSON_PROPERTY_TR_CONF_ID_ISSUE_CERTIFICATE,
  SigTypeTransactionCode.JSON_PROPERTY_TR_CONF_ID,
  SigTypeTransactionCode.JSON_PROPERTY_IS_PHONE_NUMBER_REQUIRED,
  SigTypeTransactionCode.JSON_PROPERTY_ID,
  SigTypeTransactionCode.JSON_PROPERTY_DISCRIMINATOR_TYPE,
  SigTypeTransactionCode.JSON_PROPERTY_PREFERRED,
...
public class SigTypeTransactionCode extends SigType {
  ...
  public SigTypeTransactionCode trModType(String trModType) {
  ...
  **/
  ...
  public SigTypeTransactionCode trModTypeId(String trModTypeId) {
  ...
  **/
  ...
  public SigTypeTransactionCode trValidityInSeconds(Integer trValidityInSeconds) {
  ...
  **/
  ...
  public SigTypeTransactionCode ly(String ly) {
  ...
  **/
  ...
  public SigTypeTransactionCode trConfIdIssueCertificate(String trConfIdIssueCertificate) {
  ...
  **/
  ...
  public SigTypeTransactionCode trConfId(String trConfId) {
  ...
  **/
  ...
  public SigTypeTransactionCode discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public SigTypeTransactionCode preferred(Boolean preferred) {
  ...
  **/
  ...
  public SigTypeTransactionCode stampImprintConfiguration(StampImprintConfiguration stampImprintConfiguration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SigTypeTransactionCode sigTypeTransactionCode = (SigTypeTransactionCode) o;
    return Objects.equals(this.trModType, sigTypeTransactionCode.trModType) &&
        Objects.equals(this.trModTypeId, sigTypeTransactionCode.trModTypeId) &&
        Objects.equals(this.trValidityInSeconds, sigTypeTransactionCode.trValidityInSeconds) &&
        Objects.equals(this.ly, sigTypeTransactionCode.ly) &&
        Objects.equals(this.trConfIdIssueCertificate, sigTypeTransactionCode.trConfIdIssueCertificate) &&
        Objects.equals(this.trConfId, sigTypeTransactionCode.trConfId) &&
        Objects.equals(this.isPhoneNumberRequired, sigTypeTransactionCode.isPhoneNumberRequired) &&
        Objects.equals(this.id, sigTypeTransactionCode.id) &&
        Objects.equals(this.discriminatorType, sigTypeTransactionCode.discriminatorType) &&
        Objects.equals(this.preferred, sigTypeTransactionCode.preferred) &&
        Objects.equals(this.stampImprintConfiguration, sigTypeTransactionCode.stampImprintConfiguration) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class SigTypeTransactionCode {\n");
