...
/**
 * SigTypeTransactionCodeAndLocalCertificateAllOf
 */
@JsonPropertyOrder({
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_TR_MOD_TYPE,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_TR_MOD_TYPE_ID,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_TR_VALIDITY_IN_SECONDS,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_LY,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_TR_CONF_ID_ISSUE_CERTIFICATE,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_TR_CONF_ID,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_IS_PHONE_NUMBER_REQUIRED,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_ID,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_DISCRIMINATOR_TYPE,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_PREFERRED,
  SigTypeTransactionCodeAndLocalCertificateAllOf.JSON_PROPERTY_STAMP_IMPRINT_CONFIGURATION
})
@JsonTypeName("SigTypeTransactionCodeAndLocalCertificate_allOf")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-02-28T10:42:13.714738+01:00[Europe/Berlin]")
public class SigTypeTransactionCodeAndLocalCertificateAllOf {
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf trModType(String trModType) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf trModTypeId(String trModTypeId) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf trValidityInSeconds(Integer trValidityInSeconds) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf ly(String ly) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf trConfIdIssueCertificate(String trConfIdIssueCertificate) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf trConfId(String trConfId) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf isPhoneNumberRequired(Boolean isPhoneNumberRequired) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf id(String id) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf preferred(Boolean preferred) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndLocalCertificateAllOf stampImprintConfiguration(StampImprintConfiguration stampImprintConfiguration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SigTypeTransactionCodeAndLocalCertificateAllOf sigTypeTransactionCodeAndLocalCertificateAllOf = (SigTypeTransactionCodeAndLocalCertificateAllOf) o;
    return Objects.equals(this.trModType, sigTypeTransactionCodeAndLocalCertificateAllOf.trModType) &&
        Objects.equals(this.trModTypeId, sigTypeTransactionCodeAndLocalCertificateAllOf.trModTypeId) &&
        Objects.equals(this.trValidityInSeconds, sigTypeTransactionCodeAndLocalCertificateAllOf.trValidityInSeconds) &&
        Objects.equals(this.ly, sigTypeTransactionCodeAndLocalCertificateAllOf.ly) &&
        Objects.equals(this.trConfIdIssueCertificate, sigTypeTransactionCodeAndLocalCertificateAllOf.trConfIdIssueCertificate) &&
        Objects.equals(this.trConfId, sigTypeTransactionCodeAndLocalCertificateAllOf.trConfId) &&
        Objects.equals(this.isPhoneNumberRequired, sigTypeTransactionCodeAndLocalCertificateAllOf.isPhoneNumberRequired) &&
        Objects.equals(this.id, sigTypeTransactionCodeAndLocalCertificateAllOf.id) &&
        Objects.equals(this.discriminatorType, sigTypeTransactionCodeAndLocalCertificateAllOf.discriminatorType) &&
        Objects.equals(this.preferred, sigTypeTransactionCodeAndLocalCertificateAllOf.preferred) &&
        Objects.equals(this.stampImprintConfiguration, sigTypeTransactionCodeAndLocalCertificateAllOf.stampImprintConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class SigTypeTransactionCodeAndLocalCertificateAllOf {\n");
