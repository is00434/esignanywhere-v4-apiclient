 ...
 */
@ApiModel(description = "TransactionCodeAndBiometricSignature SigType.")
@JsonPropertyOrder({
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_IS_BIO,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_TR_MOD_TYPE,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_TR_MOD_TYPE_ID,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_TR_VALIDITY_IN_SECONDS,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_LY,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_TR_CONF_ID_ISSUE_CERTIFICATE,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_TR_CONF_ID,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_IS_PHONE_NUMBER_REQUIRED,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_ID,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_DISCRIMINATOR_TYPE,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_PREFERRED,
  SigTypeTransactionCodeAndBiometricSignature.JSON_PROPERTY_STAMP_IMPRINT_CONFIGURATION
})
@JsonTypeName("SigTypeTransactionCodeAndBiometricSignature")
...
public class SigTypeTransactionCodeAndBiometricSignature extends SigType {
  ...
  public SigTypeTransactionCodeAndBiometricSignature isBio(Boolean isBio) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature trModType(String trModType) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature trModTypeId(String trModTypeId) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature trValidityInSeconds(Integer trValidityInSeconds) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature ly(String ly) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature trConfIdIssueCertificate(String trConfIdIssueCertificate) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature trConfId(String trConfId) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature isPhoneNumberRequired(Boolean isPhoneNumberRequired) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature id(String id) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature preferred(Boolean preferred) {
  ...
  **/
  ...
  public SigTypeTransactionCodeAndBiometricSignature stampImprintConfiguration(StampImprintConfiguration stampImprintConfiguration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SigTypeTransactionCodeAndBiometricSignature sigTypeTransactionCodeAndBiometricSignature = (SigTypeTransactionCodeAndBiometricSignature) o;
    return Objects.equals(this.isBio, sigTypeTransactionCodeAndBiometricSignature.isBio) &&
        Objects.equals(this.trModType, sigTypeTransactionCodeAndBiometricSignature.trModType) &&
        Objects.equals(this.trModTypeId, sigTypeTransactionCodeAndBiometricSignature.trModTypeId) &&
        Objects.equals(this.trValidityInSeconds, sigTypeTransactionCodeAndBiometricSignature.trValidityInSeconds) &&
        Objects.equals(this.ly, sigTypeTransactionCodeAndBiometricSignature.ly) &&
        Objects.equals(this.trConfIdIssueCertificate, sigTypeTransactionCodeAndBiometricSignature.trConfIdIssueCertificate) &&
        Objects.equals(this.trConfId, sigTypeTransactionCodeAndBiometricSignature.trConfId) &&
        Objects.equals(this.isPhoneNumberRequired, sigTypeTransactionCodeAndBiometricSignature.isPhoneNumberRequired) &&
        Objects.equals(this.id, sigTypeTransactionCodeAndBiometricSignature.id) &&
        Objects.equals(this.discriminatorType, sigTypeTransactionCodeAndBiometricSignature.discriminatorType) &&
        Objects.equals(this.preferred, sigTypeTransactionCodeAndBiometricSignature.preferred) &&
        Objects.equals(this.stampImprintConfiguration, sigTypeTransactionCodeAndBiometricSignature.stampImprintConfiguration) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class SigTypeTransactionCodeAndBiometricSignature {\n");
