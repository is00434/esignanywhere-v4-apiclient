 ...
 */
@ApiModel(description = "Authentication with Google.")
@JsonPropertyOrder({
  AuthenticationMethodGoogle.JSON_PROPERTY_DISCRIMINATOR_TYPE
})
@JsonTypeName("AuthenticationMethodGoogle")
...
public class AuthenticationMethodGoogle extends AuthenticationMethod {
  public static final String JSON_PROPERTY_DISCRIMINATOR_TYPE = "DiscriminatorType";
  protected String discriminatorType;


  public AuthenticationMethodGoogle discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthenticationMethodGoogle authenticationMethodGoogle = (AuthenticationMethodGoogle) o;
    return Objects.equals(this.discriminatorType, authenticationMethodGoogle.discriminatorType) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthenticationMethodGoogle {\n");
