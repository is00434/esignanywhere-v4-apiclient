...
/**
 * TypewriterAnnotationAllOf
 */
@JsonPropertyOrder({
  TypewriterAnnotationAllOf.JSON_PROPERTY_PAGE_NUMBER,
  TypewriterAnnotationAllOf.JSON_PROPERTY_TEXT_ALIGN,
  TypewriterAnnotationAllOf.JSON_PROPERTY_POSITION,
  TypewriterAnnotationAllOf.JSON_PROPERTY_DEFAULT_TEXT,
  TypewriterAnnotationAllOf.JSON_PROPERTY_TEXT_FORMAT,
  TypewriterAnnotationAllOf.JSON_PROPERTY_DEFAULT_TEXT_TYPE,
  TypewriterAnnotationAllOf.JSON_PROPERTY_FONT_SETTINGS,
  TypewriterAnnotationAllOf.JSON_PROPERTY_IS_EDITABLE_POSITION,
  TypewriterAnnotationAllOf.JSON_PROPERTY_IS_EDITABLE_DEFAULT_TEXT,
  TypewriterAnnotationAllOf.JSON_PROPERTY_IS_EDITABLE_FONT_SETTINGS,
  TypewriterAnnotationAllOf.JSON_PROPERTY_IS_REQUIRED,
  TypewriterAnnotationAllOf.JSON_PROPERTY_ID,
  TypewriterAnnotationAllOf.JSON_PROPERTY_DISPLAY_NAME,
  TypewriterAnnotationAllOf.JSON_PROPERTY_DOC_REF_NUMBER,
  TypewriterAnnotationAllOf.JSON_PROPERTY_ADDITIONAL_INFORMATION,
  TypewriterAnnotationAllOf.JSON_PROPERTY_BATCH_ID,
  TypewriterAnnotationAllOf.JSON_PROPERTY_DISCRIMINATOR_TYPE
})
@JsonTypeName("TypewriterAnnotation_allOf")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-02-13T11:25:21.496783+01:00[Europe/Berlin]")
public class TypewriterAnnotationAllOf {
  ...
  public TypewriterAnnotationAllOf pageNumber(Integer pageNumber) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf textAlign(TextAlignEnum textAlign) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf position(Position position) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf defaultText(String defaultText) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf textFormat(String textFormat) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf defaultTextType(String defaultTextType) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf fontSettings(FontSettings fontSettings) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf isEditablePosition(Boolean isEditablePosition) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf isEditableDefaultText(Boolean isEditableDefaultText) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf isEditableFontSettings(Boolean isEditableFontSettings) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf isRequired(Boolean isRequired) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf id(String id) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf displayName(String displayName) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf docRefNumber(Integer docRefNumber) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf additionalInformation(String additionalInformation) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf batchId(String batchId) {
  ...
  **/
  ...
  public TypewriterAnnotationAllOf discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TypewriterAnnotationAllOf typewriterAnnotationAllOf = (TypewriterAnnotationAllOf) o;
    return Objects.equals(this.pageNumber, typewriterAnnotationAllOf.pageNumber) &&
        Objects.equals(this.textAlign, typewriterAnnotationAllOf.textAlign) &&
        Objects.equals(this.position, typewriterAnnotationAllOf.position) &&
        Objects.equals(this.defaultText, typewriterAnnotationAllOf.defaultText) &&
        Objects.equals(this.textFormat, typewriterAnnotationAllOf.textFormat) &&
        Objects.equals(this.defaultTextType, typewriterAnnotationAllOf.defaultTextType) &&
        Objects.equals(this.fontSettings, typewriterAnnotationAllOf.fontSettings) &&
        Objects.equals(this.isEditablePosition, typewriterAnnotationAllOf.isEditablePosition) &&
        Objects.equals(this.isEditableDefaultText, typewriterAnnotationAllOf.isEditableDefaultText) &&
        Objects.equals(this.isEditableFontSettings, typewriterAnnotationAllOf.isEditableFontSettings) &&
        Objects.equals(this.isRequired, typewriterAnnotationAllOf.isRequired) &&
        Objects.equals(this.id, typewriterAnnotationAllOf.id) &&
        Objects.equals(this.displayName, typewriterAnnotationAllOf.displayName) &&
        Objects.equals(this.docRefNumber, typewriterAnnotationAllOf.docRefNumber) &&
        Objects.equals(this.additionalInformation, typewriterAnnotationAllOf.additionalInformation) &&
        Objects.equals(this.batchId, typewriterAnnotationAllOf.batchId) &&
        Objects.equals(this.discriminatorType, typewriterAnnotationAllOf.discriminatorType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pageNumber, textAlign, position, defaultText, textFormat, defaultTextType, fontSettings, isEditablePosition, isEditableDefaultText, isEditableFontSettings, isRequired, id, displayName, docRefNumber, additionalInformation, batchId, discriminatorType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TypewriterAnnotationAllOf {\n");
