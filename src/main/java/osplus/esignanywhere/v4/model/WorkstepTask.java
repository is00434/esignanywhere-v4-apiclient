 ...
 */
@ApiModel(description = "Abstract class, use the derived classes:  - Agreements  - AppendPages  - Attachment  - FormGroup  - PictureAnnotationConfiguration  - ReadingTask  - Signature  - SignPkcs7  - TypewriterAnnotation                For usage see sample code.")
@JsonPropertyOrder({
  WorkstepTask.JSON_PROPERTY_IS_REQUIRED,
  WorkstepTask.JSON_PROPERTY_ID,
  WorkstepTask.JSON_PROPERTY_DISPLAY_NAME,
  WorkstepTask.JSON_PROPERTY_DOC_REF_NUMBER,
  WorkstepTask.JSON_PROPERTY_ADDITIONAL_INFORMATION,
  WorkstepTask.JSON_PROPERTY_BATCH_ID,
  WorkstepTask.JSON_PROPERTY_DISCRIMINATOR_TYPE
})
@JsonTypeName("WorkstepTask")
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = Agreements.class, name = "Agreements"),
  @JsonSubTypes.Type(value = AppendPages.class, name = "AppendPages"),
  @JsonSubTypes.Type(value = Attachment.class, name = "Attachment"),
  @JsonSubTypes.Type(value = FormGroup.class, name = "FormGroup"),
  @JsonSubTypes.Type(value = PictureAnnotationConfiguration.class, name = "PictureAnnotationConfiguration"),
  @JsonSubTypes.Type(value = ReadingTask.class, name = "ReadingTask"),
  @JsonSubTypes.Type(value = SignPkcs7.class, name = "SignPkcs7"),
  @JsonSubTypes.Type(value = Signature.class, name = "Signature"),
  @JsonSubTypes.Type(value = TypewriterAnnotation.class, name = "TypewriterAnnotation"),
})
...
public class WorkstepTask {
  ...
  public WorkstepTask isRequired(Boolean isRequired) {
  ...
  **/
  ...
  public WorkstepTask id(String id) {
  ...
  **/
  ...
  public WorkstepTask displayName(String displayName) {
  ...
  **/
  ...
  public WorkstepTask docRefNumber(Integer docRefNumber) {
  ...
  **/
  ...
  public WorkstepTask additionalInformation(String additionalInformation) {
  ...
  **/
  ...
  public WorkstepTask batchId(String batchId) {
  ...
  **/
  ...
  public WorkstepTask discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WorkstepTask workstepTask = (WorkstepTask) o;
    return Objects.equals(this.isRequired, workstepTask.isRequired) &&
        Objects.equals(this.id, workstepTask.id) &&
        Objects.equals(this.displayName, workstepTask.displayName) &&
        Objects.equals(this.docRefNumber, workstepTask.docRefNumber) &&
        Objects.equals(this.additionalInformation, workstepTask.additionalInformation) &&
        Objects.equals(this.batchId, workstepTask.batchId) &&
        Objects.equals(this.discriminatorType, workstepTask.discriminatorType);
  }
