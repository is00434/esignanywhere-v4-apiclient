 ...
 */
@ApiModel(description = "Authentication with Facebook.")
@JsonPropertyOrder({
  AuthenticationMethodFacebook.JSON_PROPERTY_DISCRIMINATOR_TYPE
})
@JsonTypeName("AuthenticationMethodFacebook")
...
public class AuthenticationMethodFacebook extends AuthenticationMethod {
  public static final String JSON_PROPERTY_DISCRIMINATOR_TYPE = "DiscriminatorType";
  protected String discriminatorType;


  public AuthenticationMethodFacebook discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthenticationMethodFacebook authenticationMethodFacebook = (AuthenticationMethodFacebook) o;
    return Objects.equals(this.discriminatorType, authenticationMethodFacebook.discriminatorType) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthenticationMethodFacebook {\n");
