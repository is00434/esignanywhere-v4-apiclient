...
/**
 * Abstract class, use the derived classes:  - UserAuthenticationSaml                For usage see sample code.
 */
@ApiModel(description = "Abstract class, use the derived classes:  - UserAuthenticationSaml                For usage see sample code.")
@JsonPropertyOrder({
  UserAuthentication.JSON_PROPERTY_DISCRIMINATOR_TYPE
})
...
public class UserAuthentication {
  ...
  public UserAuthentication discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.discriminatorType, userAuthentication.discriminatorType);
  }
