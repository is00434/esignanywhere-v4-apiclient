 ...
 */
@ApiModel(description = "Uses  UserIds as authentication method.")
@JsonPropertyOrder({
  AuthenticationMethodUserId.JSON_PROPERTY_USER_IDS,
  AuthenticationMethodUserId.JSON_PROPERTY_DISCRIMINATOR_TYPE
})
@JsonTypeName("AuthenticationMethodUserId")
...
public class AuthenticationMethodUserId extends AuthenticationMethod {
  ...
  public AuthenticationMethodUserId userIds(List<String> userIds) {
    
    this.userIds = userIds;
    return this;
  }

  public AuthenticationMethodUserId addUserIdsItem(String userIdsItem) {
  ...
  **/
  ...
  public AuthenticationMethodUserId discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AuthenticationMethodUserId authenticationMethodUserId = (AuthenticationMethodUserId) o;
    return Objects.equals(this.userIds, authenticationMethodUserId.userIds) &&
        Objects.equals(this.discriminatorType, authenticationMethodUserId.discriminatorType) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userIds, discriminatorType, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuthenticationMethodUserId {\n");
