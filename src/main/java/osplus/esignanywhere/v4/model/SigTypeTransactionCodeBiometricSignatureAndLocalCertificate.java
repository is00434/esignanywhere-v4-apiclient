 ...
 */
@JsonPropertyOrder({
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_IS_BIO,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_TR_MOD_TYPE,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_TR_MOD_TYPE_ID,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_TR_VALIDITY_IN_SECONDS,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_LY,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_TR_CONF_ID_ISSUE_CERTIFICATE,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_TR_CONF_ID,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_IS_PHONE_NUMBER_REQUIRED,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_ID,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_DISCRIMINATOR_TYPE,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_PREFERRED,
  SigTypeTransactionCodeBiometricSignatureAndLocalCertificate.JSON_PROPERTY_STAMP_IMPRINT_CONFIGURATION
})
@JsonTypeName("SigTypeTransactionCodeBiometricSignatureAndLocalCertificate")
...
public class SigTypeTransactionCodeBiometricSignatureAndLocalCertificate extends SigType {
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate isBio(Boolean isBio) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate trModType(String trModType) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate trModTypeId(String trModTypeId) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate trValidityInSeconds(Integer trValidityInSeconds) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate ly(String ly) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate trConfIdIssueCertificate(String trConfIdIssueCertificate) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate trConfId(String trConfId) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate isPhoneNumberRequired(Boolean isPhoneNumberRequired) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate id(String id) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate discriminatorType(String discriminatorType) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate preferred(Boolean preferred) {
  ...
  **/
  ...
  public SigTypeTransactionCodeBiometricSignatureAndLocalCertificate stampImprintConfiguration(StampImprintConfiguration stampImprintConfiguration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SigTypeTransactionCodeBiometricSignatureAndLocalCertificate sigTypeTransactionCodeBiometricSignatureAndLocalCertificate = (SigTypeTransactionCodeBiometricSignatureAndLocalCertificate) o;
    return Objects.equals(this.isBio, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.isBio) &&
        Objects.equals(this.trModType, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.trModType) &&
        Objects.equals(this.trModTypeId, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.trModTypeId) &&
        Objects.equals(this.trValidityInSeconds, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.trValidityInSeconds) &&
        Objects.equals(this.ly, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.ly) &&
        Objects.equals(this.trConfIdIssueCertificate, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.trConfIdIssueCertificate) &&
        Objects.equals(this.trConfId, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.trConfId) &&
        Objects.equals(this.isPhoneNumberRequired, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.isPhoneNumberRequired) &&
        Objects.equals(this.id, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.id) &&
        Objects.equals(this.discriminatorType, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.discriminatorType) &&
        Objects.equals(this.preferred, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.preferred) &&
        Objects.equals(this.stampImprintConfiguration, sigTypeTransactionCodeBiometricSignatureAndLocalCertificate.stampImprintConfiguration) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isBio, trModType, trModTypeId, trValidityInSeconds, ly, trConfIdIssueCertificate, trConfId, isPhoneNumberRequired, id, discriminatorType, preferred, stampImprintConfiguration, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SigTypeTransactionCodeBiometricSignatureAndLocalCertificate {\n");
